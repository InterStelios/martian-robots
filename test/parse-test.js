...
const { prune, extractProperties, extractSurfaceSize } = require('../src/utils/parse')
...
describe('parse utils', () => {
  describe('#prune()', () => {
    ...
    it('should throw an error if instruction string is greater than 100', () => {
      ...
      const input = `5 3\n1 1 E\n${instructions}`
      assert.throws(prune.bind(null, input), Error, 'Instruction strings should be less than 100 characters in length')
    })
  })
